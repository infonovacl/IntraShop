<%@ Page Language="VB" MasterPageFile="~/Maestro.master" EnableViewState="true" AutoEventWireup ="false" CodeFile="ClienteSINAJAX.aspx.vb" Inherits="Cliente" %>
    ...
    <div>   
        ...
        <div id="div_TabConsultas">        
            <ajaxtoolkit:tabcontainer ID="Tab_Consultas" runat="server"  
                ...
                OnClientActiveTabChanged="clientActiveTabChanged" ActiveTabIndex="5" 
