<%@ Page Language="VB" AutoEventWireup="false" EnableViewState="true" CodeFile="Copy of Consultas_BuscaXNombre.aspx.vb" Inherits="Consultas_BuscaXNombre" %>
<!DOCTYPE html>
...
<body style="width: 627px; height: 2px; left: 5px;" >
    ...
    <div class="auto-style7">
        <asp:ScriptManager ID="ScriptManager1" runat="server" 
            AsyncPostBackTimeout="120" EnableViewState="False" LoadScriptsBeforeUI="False" 
            ScriptMode="Release">
                    </asp:ScriptManager>
