    ...
    Private Sub GeneraPDFEECC()
        ...
        For L = 0 To Grilla_TramaEECC.Rows.Count - 1
            If Me.Grilla_TramaEECC.Rows(L).Cells(0).Text.Substring(0, 2) = "E1" Then
                Try
                    Dim rut As String = Me.Grilla_TramaEECC.Rows(L).Cells(0).Text.Substring(3, 9)
                    ...
                    Dim cupo_aprobado As Integer = Me.Grilla_TramaEECC.Rows(L).Cells(0).Text.Substring(236, 9) '228
                    Dim cupo_utilizado As Integer = Me.Grilla_TramaEECC.Rows(L).Cells(0).Text.Substring(245, 9) '237
                    Dim cupo_disponible As Integer = Me.Grilla_TramaEECC.Rows(L).Cells(0).Text.Substring(254, 9) '246
