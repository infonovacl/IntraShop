Partial Class Solicitudes_RevisaRechazos
    ...
    Protected Sub Page_Load(sender As Object, e As EventArgs) Handles Me.Load
        ...
        Me.LBL_RevisaRechazos.Visible = False
    ...
    Private Sub LlenaCheckBoxRechazos()
        ...
        Try
            ...
            If DATADSConsultaSubEstadoPopUp.Tables(0).Rows(0)(0) = 1 Then
                Me.LBL_RevisaRechazos.Visible = True
                Me.LBL_RevisaRechazos.Text = DATADSConsultaSubEstadoPopUp.Tables(0).Rows(0)(1) ' mensaje de error              
            Else
                Dim x As Integer
