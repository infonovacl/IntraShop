...
Partial Class Mantencion_Tarjetas
    ...
    Protected Sub VerPDFPEP()
        ...
        embed += "</object>"
        Try
            Dim File As String = HttpContext.Current.Server.MapPath("~/Doc/PEP/contrato_" & Session("rut") & "_" & Session("dv") & ".pdf")
            If (System.IO.File.Exists(File)) Then
                Me.Literal1.Text = String.Format(embed, ResolveUrl("~/Doc/PEP/contrato_" & Session("rut") & "_" & Session("dv") & ".pdf"))
            Else
