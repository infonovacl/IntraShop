<%@ Page Language="VB" AutoEventWireup="false" CodeFile="Copy of Mantenciones_FirmaDoc.aspx.vb" Inherits="Mantencion_FirmaDoc" %>
...
<body style="width: 689px; height: 624px;">
    ...
    <div class="auto-style12">       
                ...
                &nbsp;<asp:HyperLink ID="Link_DescargaWacom" runat="server" 
                    CssClass="etiquetas_cerrarsesion" 
                    NavigateUrl="~/Utiles/Wacom-STU-SDK-2.10.0.msi" 
                    ToolTip="Descargar Driver y SDK para PAD Wacom de Firmas">Descarga WacomSDK</asp:HyperLink>
...
&nbsp;
                            ...
                            <asp:MultiView ID="MultiView_FirmaDocs" runat="server">
                                ...
                                <br />
                                        <asp:TextBox ID="TXT_IntroContrato" runat="server" BorderStyle="None" 
                                            CssClass="etiquetas_introdoc" Height="60px" ReadOnly="True" Rows="2" 
                                ...
                                <br />
                                        <table class="style2">
                                            <tr>
                                                ...
                                                <td class="style7">
                                                    <asp:Button ID="BTN_ContratoRechaza" runat="server" CssClass="botones_anchoX2" 
                                ...
                                <br />
                                        <table align="center" class="auto-style7">
                                            ...
                                            onClick="javascript: initDemo()" class="auto-style32" />
                                                    ...
                                                    &nbsp;&nbsp;&nbsp;&nbsp;&nbsp;
                                                    <asp:Button ID="BTN_VerContrato" runat="server" CssClass="botones_anchoX2" 
                                                        Height="22px" 
                                                        OnClientClick="javascript:my_window=window.open('/Mantenciones/Mantenciones_VerContrato.aspx','VerContrato','top=120 ,left=240,width=600,height=580',scrollbars='NO',resizable='NO',toolbar='NO');my_window.focus()" 
                                                        Text="VER CONTRATO" />
                                                    <br />
                                                    <br />
                                                    <asp:Button ID="BTN_VerPREContrato" runat="server" CssClass="botones_anchoX2" 
                                                        Height="22px" Text="VER PRE-CONTRATO" />
                                                    </td>
                                            </tr>
                                        </table>
                                    </asp:Panel>
                                ...
                                <br />
                                        <table class="style2">
                                            <tr>
                                                ...
                                                <td class="style7">
                                                    <asp:Button ID="BTN_SeguroProteccionRechaza" runat="server" 
                ...
                onClick="javascript: initDemoSP()" class="auto-style32" />
                                                    ...
                                                    &nbsp;&nbsp;&nbsp;&nbsp;&nbsp;
                                                    <asp:Button ID="BTN_VerSP" runat="server" CssClass="botones_anchoX2" 
                                                        Height="22px" 
                                                        OnClientClick="javascript:my_window=window.open('/Mantenciones/Mantenciones_VerSeguroProteccion.aspx','VerSeguroProteccion','top=120 ,left=240,width=600,height=580',scrollbars='NO',resizable='NO',toolbar='NO');my_window.focus()" 
                                                        Text="VER SEGURO" />
                                                </td>
                                            </tr>
                                        </table>
                                ...
                                <br />
                                        <table class="style2">
                                            <tr>
                                                ...
                                                <td class="style7">
                                                    <asp:Button ID="BTN_SeguroVidaRechaza" runat="server" 
                                                        CssClass="botones_anchoX2" Height="22px" Text="RECHAZA" />
                                                </td>
                                            </tr>
                                        </table>
                                ...
                                <br />
                                        <table align="center" class="auto-style7">
                                            ...
                                            onClick="javascript: initDemoSV()" class="auto-style32"/>
                                                    ...
                                                    &nbsp;&nbsp;&nbsp;&nbsp;&nbsp;
                                                    <asp:Button ID="BTN_VerSV" runat="server" CssClass="botones_anchoX2" 
                                                        Height="22px" 
                                                        OnClientClick="javascript:my_window=window.open('/Mantenciones/Mantenciones_VerSeguroVida.aspx','VerSeguroVida','top=120 ,left=240,width=600,height=580',scrollbars='NO',resizable='NO',toolbar='NO');my_window.focus()" 
                                                        Text="VER SEGURO" />
                                                </td>
                                            </tr>
                                        </table>
