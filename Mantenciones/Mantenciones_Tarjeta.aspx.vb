...
Partial Class Mantencion_Tarjetas
    ...
    Protected Sub BTN_Seguros_Click(sender As Object, e As EventArgs) Handles BTN_Firmar.Click
        ...
        Dim ruta_pdf_cliente As String = HttpContext.Current.Server.MapPath("~/Doc/Contrato_FamilyShop_" & Session("rut") & "_" & Session("dv") & ".pdf") ' PDF destino 
        ...
        PDFDoc2.Save(HttpContext.Current.Server.MapPath("~/Doc/Contrato_FamilyShop_" & Session("rut") & "_" & Session("dv") & ".pdf"))
