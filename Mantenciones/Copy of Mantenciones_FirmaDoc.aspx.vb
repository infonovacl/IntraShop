...
Partial Class Mantencion_FirmaDoc
    ...
    Protected Sub BTN_FirmarContrato_Click(ByVal sender As Object, ByVal e As EventArgs) Handles BTN_FirmarContrato.Click
        ...
        Try
            If Me._hdnSignature.Value <> Nothing Then
                ...
                gfx.DrawString(Trim(ClienteCalleParticular) & " NRO " & Trim(ClienteNumeroDepto) & " " & Trim(ClienteNumeroDepto), font, XBrushes.Black, New XVector(170, 152))
    ...
    Protected Sub BTN_FirmarSV_Click(ByVal sender As Object, ByVal e As System.EventArgs) Handles BTN_FirmarSV.Click
        ...
        Try
            If Me._hdnSignatureSV.Value <> Nothing Then
                ...
                gfx.DrawString(Trim(ClienteAPaterno) & " " & Trim(ClienteAMaterno) & " " & Trim(ClienteNombres), font, XBrushes.Black, New XVector(65, 144))
                gfx.DrawString(" " & Session("rut") & "-" & Session("dv"), font, XBrushes.Black, New XVector(490, 144))
                gfx.DrawString(Trim(ClienteCalleParticular) & " NRO " & Trim(ClienteNumeroCasa) & " " & Trim(ClienteNumeroDepto), font, XBrushes.Black, New XVector(65, 170))
                gfx.DrawString(Trim(ClienteComuna), font, XBrushes.Black, New XVector(355, 170))

                gfx.DrawString(Trim(ClienteTelefonoFijo), font, XBrushes.Black, New XVector(65, 195))
                gfx.DrawString(Trim(ClienteTelefonoCelular), font, XBrushes.Black, New XVector(270, 195))
                gfx.DrawString(Trim(ClienteCorreoElectronico), font, XBrushes.Black, New XVector(380, 195))

                gfx.DrawString(Trim(ClienteFechaNac), font, XBrushes.Black, New XVector(65, 220))
                gfx.DrawString(Trim(ClienteSexo), font, XBrushes.Black, New XVector(190, 220))
                gfx.DrawString(Trim(ClienteEstadoCivil), font, XBrushes.Black, New XVector(255, 220))
    ...
    Protected Sub IntroDocumento(ByVal TipoDoc As String)
        ...
        Try
            ...
            If TipoDoc = "CON" Then
                ...
                Me.TXT_IntroContrato.Text = DataDSIntroDocumento.Tables(0).Rows(0)(1) ' mensaje contrato
            ElseIf TipoDoc = "SDE" Then
                Me.TXT_IntroSeguroProteccion.Visible = True
                Me.TXT_IntroSeguroProteccion.Text = DataDSIntroDocumento.Tables(0).Rows(0)(1) ' mensaje seguro proteccion
            ElseIf TipoDoc = "SVI" Then
                Me.TXT_IntroSeguroVida.Visible = True
                Me.TXT_IntroSeguroVida.Text = DataDSIntroDocumento.Tables(0).Rows(0)(1) ' mensaje seguro vida
            End If                       
        Catch ex As Exception
    ...
    Protected Sub BTN_ContratoAcepta_Click(ByVal sender As Object, ByVal e As System.EventArgs) Handles BTN_ContratoAcepta.Click
        Me.BTN_ContratoRechaza.Enabled = False
        Me.Panel_FirmaContrato.Visible = True
        'Me.LBL_DatosClienteError.Visible = False
        'Me.LBL_DatosClienteError.Text = ""
        'Me.RBL_Documentos.Enabled = True
    End Sub
    Protected Sub BTN_SeguroProteccionAcepta_Click(ByVal sender As Object, ByVal e As System.EventArgs) Handles BTN_SeguroProteccionAcepta.Click
        Me.BTN_SeguroProteccionRechaza.Enabled = False
    ...
    Protected Sub BTN_SeguroVidaAcepta_Click(ByVal sender As Object, ByVal e As System.EventArgs) Handles BTN_SeguroVidaAcepta.Click
        Me.BTN_SeguroVidaRechaza.Enabled = False
        Me.Panel_FirmaSeguroVida.Visible = True
    End Sub
    Protected Sub BTN_SeguroProteccionRechaza_Click(ByVal sender As Object, ByVal e As System.EventArgs) Handles BTN_SeguroProteccionRechaza.Click
        Me.IMG_SeguroProteccionFirmado.Visible = False
        Me.IMG_SeguroProteccionRechazado.Visible = True
    End Sub
    Protected Sub BTN_SeguroVidaRechaza_Click(ByVal sender As Object, ByVal e As System.EventArgs) Handles BTN_SeguroVidaRechaza.Click
        Me.IMG_SeguroVidaFirmado.Visible = False
        Me.IMG_SeguroVidaRechazado.Visible = True
    End Sub
    Protected Sub BTN_ContratoRechaza_Click(ByVal sender As Object, ByVal e As System.EventArgs) Handles BTN_ContratoRechaza.Click
        Response.Write("<script>window.alert('ADVERTENCIA : SI CLIENTE RECHAZA CONTRATO NO PUEDE CONTINUAR ESTE PROCESO');</script>")
    ...
    Protected Sub ValidaDocsAFirmar()
        ...
        Try
            ...
            Else
                If DataDSDocsFirmados.Tables(0).Rows(0)(2) = 0 Then 'Si el valor es 0 significa que ya se firmo el documento
                    Me.IMG_ContratoFirmado.Visible = True
                    Me.IMG_ContratoRechazado.Visible = False
                    Me.RBL_Documentos.Items(0).Enabled = False
                    Me.RBL_Documentos.Items(1).Enabled = True
                    Me.RBL_Documentos.Items(2).Enabled = True

                    If DataDSDocsFirmados.Tables(0).Rows(0)(3) = 0 Then 'Si el valor es 0 significa que ya se firmo el documento
                        Me.IMG_SeguroProteccionFirmado.Visible = True
                        Me.IMG_SeguroProteccionRechazado.Visible = False
                    ...
                    Else                                                'si es mayor a 0 indica el código del contrato pendiente de firma
                        ...
                        Me.RBL_Documentos.Items(1).Enabled = True
                    End If
                    If DataDSDocsFirmados.Tables(0).Rows(0)(4) = 0 Then 'Si el valor es 0 significa que ya se firmo el documento
                        Me.IMG_SeguroVidaFirmado.Visible = True
                        Me.IMG_SeguroVidaRechazado.Visible = False
