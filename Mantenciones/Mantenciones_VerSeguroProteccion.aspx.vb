...
Partial Class Mantencion_Tarjetas_SeguroProteccion
    ...
    Protected Sub BTN_Cerrar_Click(ByVal sender As Object, ByVal e As EventArgs) Handles BTN_Cerrar.Click
        ...
        End If
    End Sub
    Protected Sub VerPDFSeguroProteccion()
        ...
        embed += "</object>"
        Try
            Dim File As String = HttpContext.Current.Server.MapPath("~/Doc/SeguroProteccion/seguro_proteccion_" & Session("rut") & "_" & Session("dv") & ".pdf")
            If (System.IO.File.Exists(File)) Then
                Me.Literal1.Text = String.Format(embed, ResolveUrl("~/Doc/SeguroProteccion/seguro_proteccion_" & Session("rut") & "_" & Session("dv") & ".pdf"))
            Else
