            ...
            If Page.IsValid = True Then              
                    ...
                    Else
                        ...
                        If TipoConsulta = "bloqueo" Then
                            ClientScript.RegisterClientScriptBlock(Me.GetType(), "Bloqueo", "<script> LLamaBloqueos('/Solicitudes/Solicitudes_Bloqueos.aspx?rut=" & Me.TXT_Rut.Text & "&dv=" & Me.TXT_Dv.Text & "&usuario=" & Usuario & "&codtienda=" & CodTienda & "&caja=" & CodCaja & "'); </script>")
                        ElseIf TipoConsulta = "verificacion" Then
                            ClientScript.RegisterClientScriptBlock(Me.GetType(), "Verificacion", "<script> LLamaVerificacion('/Solicitudes/Solicitudes_RevisaVerificacion.aspx?rut=" & Me.TXT_Rut.Text & "&dv=" & Me.TXT_Dv.Text & "&usuario=" & Usuario & "&codtienda=" & CodTienda & "&caja=" & CodCaja & "'); </script>")
