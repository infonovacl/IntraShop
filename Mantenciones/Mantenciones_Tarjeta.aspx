    ...
    <div class="auto-style12">       
                ...
                <table class="auto-style7" align="center">
                    <tr>
                        <td class="auto-style9">                                         
                            ...
                            <asp:Button ID="BTN_Firmar" runat="server" CssClass="botones_ancho" Text="FIRMAR" OnClientClick="javascript:return signForm();" />
                            &nbsp;&nbsp;&nbsp;                         
                    ...
                    <cc2:TabPanel ID="TabPanel4" runat="server" HeaderText="TabPanel4">
                        ...
                        <ContentTemplate>
                            <asp:Button ID="BTN_Tarjeta" runat="server" CssClass="botones" Text="TARJETA" Width="100px" />
                        </ContentTemplate>
                    </cc2:TabPanel>
                    <cc2:TabPanel ID="TabPanel5" runat="server" HeaderText="TabPanel5">
                        <HeaderTemplate>
                            Tarjeta
                        </HeaderTemplate>
                        <ContentTemplate>
                            <asp:Button ID="BTN_PopUp" runat="server" CssClass="botones" Text="POPUP" Width="100px" OnClientClick="javascript:window.open('/Consultas/Consultas_GestionCobranza.aspx','popup','width=800,height=500');" />
                        </ContentTemplate>
                    </cc2:TabPanel>
                </cc2:TabContainer>
            </ContentTemplate>
        ...
        <div class="auto-style34">
                <table class="auto-style33" align="center">
                    <tr>
                        <td class="auto-style9"><asp:Button ID="BTN_Grabar" runat="server" CssClass="botones_ancho" Text="GRABAR" />                         
                            &nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;                         
                            <asp:Button ID="BTN_Cerrar" runat="server" CssClass="botones_ancho" Text="CERRAR" />
                            &nbsp;&nbsp;&nbsp;&nbsp; &nbsp;&nbsp;
                            <asp:Button runat="server" Text="CONTRATO" CssClass="botones_ancho" ID="BTN_Contrato"></asp:Button>
