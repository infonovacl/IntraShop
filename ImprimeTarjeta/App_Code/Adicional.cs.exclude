...
{
    public String AdicXml(Int32 rutTit, String dvTit, Int32 rutAdic, String dvAdic, String nombres, String apellidos, String expiracion, String numeroTarj, String version)
    {
        ...
        string strXml = "<DATA_TAR>" +
                ...
                "<TRACKS> " +
                    "<TOTAL> 2 </TOTAL> " +
                        ...
                        "<TRACK idt = '2' numero = '2' datos = '" + "000000000" + Convert.ToString(rutTit) + dvTit + Convert.ToString(rutAdic) + dvAdic + version + expiracion + "001" + "'/> " +
                "</TRACKS> " +
            "</DATA_TAR>";
        return strXml;
    }
